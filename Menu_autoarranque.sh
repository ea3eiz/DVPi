...
if [ $dstar = "ON" ]
then
echo "   ${GRIS} 1) $desconectar  ${VERDE}\t$estado ON ${CIAN}    \t${VERDE}ircDDB"
else
echo "   ${GRIS} 1) $conectar  ${ROJO}\t$estado OFF ${CIAN}    \t${ROJO}ircDDB"
fi
#==================================================================================
...
if [ $bluedv = "ON" ]
then
echo "   ${GRIS} 2) $desconectar  ${VERDE}\t$estado ON ${CIAN}    \t${VERDE}BlueDV"
else
echo "   ${GRIS} 2) $conectar  ${ROJO}\t$estado OFF ${CIAN}    \t${ROJO}BlueDV"
fi
#==================================================================================
...
if [ $C4F = "ON" ]
then
echo "   ${GRIS} 3) $desconectar  ${VERDE}\t$estado ON ${CIAN}    \t${VERDE}YSF"
else
echo "   ${GRIS} 3) $conectar  ${ROJO}\t$estado OFF ${CIAN}    \t${ROJO}YSF"
fi
#==================================================================================
...
if [ $MMDVMPLACA = "ON" ]
then
echo "   ${GRIS} 5) $desconectar  ${VERDE}\t$estado ON ${CIAN}    \t${VERDE}Radio"
else
echo "   ${GRIS} 5) $conectar  ${ROJO}\t$estado OFF ${CIAN}    \t${ROJO}Radio"
fi
#==================================================================================
...
if [ $MMDVMLIBRE = "ON" ]
then
echo "   ${GRIS} 7) $desconectar  ${VERDE}\t$estado ON ${CIAN}    \t${VERDE}ESPECIAL"
else
echo "   ${GRIS} 7) $conectar  ${ROJO}\t$estado OFF ${CIAN}    \t${ROJO}ESPECIAL"
fi
#==================================================================================
...
if [ $SVXLINK = "ON" ]
then
echo "   ${GRIS} 9) $desconectar  ${VERDE}\t$estado ON ${CIAN}    \t${VERDE}SVXLINK"
else
echo "   ${GRIS} 9) $conectar  ${ROJO}\t$estado OFF ${CIAN}    \t${ROJO}SVXLINK"
fi
#==================================================================================
...
if [ $solod = "ON" ]
then
echo "   ${GRIS}10) $desconectar  ${VERDE}\t$estado ON ${CIAN}    \t${VERDE}SOLO_DSTAR"
else
echo "   ${GRIS}10) $conectar  ${ROJO}\t$estado OFF ${CIAN}    \t${ROJO}SOLO_DSTAR"
fi
#=================================================================================
...
if [ $ambeserver = "ON" ]
then
echo "   ${GRIS}13) $desconectar  ${VERDE}\t$estado ON ${CIAN}    \t${VERDE}AMBE SERVER"
else
echo "   ${GRIS}13) $conectar  ${ROJO}\t$estado OFF ${CIAN}    \t${ROJO}AMBE SERVER"
fi
#=================================================================================
...
if [ $ysfdmr = "ON" ]
then
echo "   ${GRIS}14) $desconectar  ${VERDE}\t$estado ON ${CIAN}    \t${VERDE}YSF2DMR"
else
echo "   ${GRIS}14) $conectar  ${ROJO}\t$estado OFF ${CIAN}    \t${ROJO}YSF2DMR"
fi
#=================================================================================
...
if [ $dmrysf = "ON" ]
then
echo "   ${GRIS}15) $desconectar  ${VERDE}\t$estado ON ${CIAN}    \t${VERDE}DMR2YSF"
else
echo "   ${GRIS}15) $conectar  ${ROJO}\t$estado OFF ${CIAN}    \t${ROJO}DMR2YSF"
fi
#=================================================================================
...
if [ $dmrnxdn = "ON" ]
then
echo "   ${GRIS}16) $desconectar  ${VERDE}\t$estado ON ${CIAN}    \t${VERDE}DMR2NXDN"
else
echo "   ${GRIS}16) $conectar  ${ROJO}\t$estado OFF ${CIAN}    \t${ROJO}DMR2NXDN"
fi
#=================================================================================
...
if [ $nxdn = "ON" ]
then
echo "   ${GRIS}17) $desconectar  ${VERDE}\t$estado ON ${CIAN}    \t${VERDE}NXDN"
else
echo "   ${GRIS}17) $conectar  ${ROJO}\t$estado OFF ${CIAN}    \t${ROJO}NXDN"
fi
#=================================================================================
...
if [ $dmrgateway = "ON" ]
then
echo "   ${GRIS}18) $desconectar  ${VERDE}\t$estado ON ${CIAN}    \t${VERDE}DMRGateway"
else
echo "   ${GRIS}18) $conectar  ${ROJO}\t$estado OFF ${CIAN}    \t${ROJO}DMRGateway"
fi
#=========================================================================*========
