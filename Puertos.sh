...
echo  "${CIAN}   1)${GRIS} Elegir Puerto ACM0"
echo  "${CIAN}   2)${GRIS} Elegir Puerto ACM1"
echo  "${CIAN}   3)${GRIS} Elegir Puerto ACM2"
echo  "${CIAN}   4)${GRIS} Elegir Puerto ACM3"
echo  "${CIAN}   5)${GRIS} Elegir Puerto AMA0"
echo  "${CIAN}   6)${GRIS} Elegir Puerto AMA1"
echo  "${CIAN}   7)${GRIS} Elegir Puerto AMA2"
echo  "${CIAN}   8)${GRIS} Elegir Puerto AMA3"
echo  "${CIAN}   9)${GRIS} Elegir Puerto AMA0"
echo  "${CIAN}  10)${GRIS} Elegir Puerto USB0"
echo  "${CIAN}  11)${GRIS} Elegir Puerto USB1"
echo  "${CIAN}  12)${GRIS} Elegir Puerto USB2"
echo  "${CIAN}  13)${GRIS} Elegir Puerto USB3"
echo ""
echo "   ${ROJO}0) Salir"
echo ""
